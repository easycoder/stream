#!/usr/bin/env bash
# Deploy the stream.eclecity.net site to DreamHost.
#
# Remote layout:
...
REMOTE="eclecity@eclecity.net:/home/eclecity/stream.eclecity.net"
...
echo "Deploying stream.eclecity.net from ${LOCAL}..."

tar czf /tmp/stream-deploy.tar.gz \
    -C "$LOCAL" \
